...
const Experience = () => {
  return (
    <div className="flex flex-col px-56">
      ...
      <div className="border border-gray-400 bg-gradient-to-b from-gray-200 to-gray-100 dark:bg-gradient-to-b dark:from-gray-400 dark:to-gray-100 shadow-sm p-8 rounded-md">
        ...
        <div className="mb-3 text-start">
          <strong className="text-purple-600 dark:text-gray-700 underline">
